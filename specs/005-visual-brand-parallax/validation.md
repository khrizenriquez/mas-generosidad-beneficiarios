...
- `npm run test:e2e` y `CI=true npm run test:e2e` pasaron: 22 pruebas en Chromium móvil y escritorio, incluyendo zoom de imagen al 120%, foco de teclado, movimiento reducido, placeholder, footer y Axe WCAG A/AA.
