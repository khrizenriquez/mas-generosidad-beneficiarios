...
- [x] T007 Completar `npm run verify` y validar los checks de GitHub Actions.
...
- [x] T012 Registrar evidencia final, subir una sola rama de fix y entregar un único PR para revisión humana.
